...
const {SignPdfError, Signer} = require('@signpdf/utils');
...
module.exports.P12Signer = class P12Signer extends Signer {
    /**
     * @param {Buffer} p12Buffer
     * @param {SignerOptions} additionalOptions
     */
    constructor(p12Buffer, passphrase, additionalOptions = {}) {
        super();

        // print instance type of p12Buffer
        console.log('p12Buffer type: ' + Object.prototype.toString.call(p12Buffer));
